class Question {
  ...
  display(){
   ...
   // this.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );
    this.question.html("Question:- What is the rarest skin you can get in Fortnite? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Toona Fish " );
    this.option1.position(150, 100);
    this.option2.html("2: Raptor " );
    this.option2.position(150, 120);
    this.option3.html("3: Renegade Raider " );
    this.option3.position(150, 140);
    this.option4.html("4: Battlehawk " );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Thanks, Your Answer Is Submitted!");
